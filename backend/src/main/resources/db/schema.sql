...
(
    ...
    payment_code                VARCHAR(32) NOT NULL COMMENT '支付单号',
    ...
    original_transaction_code   VARCHAR(32) NULL COMMENT '原流水号（退款时使用）',
...
-- 支付流水表索引
CREATE INDEX idx_payment_code ON cms_payment_transaction (payment_code);
...
CREATE INDEX idx_original_transaction_code ON cms_payment_transaction (original_transaction_code);
