package com.bytz.cms.payment.infrastructure.assembler;
...
public interface InfrastructureAssembler {
    ...
    com.bytz.cms.payment.infrastructure.entity.PaymentEntity toPaymentEntity(PaymentAggregate aggregate);
    ...
    PaymentAggregate toPaymentAggregate(com.bytz.cms.payment.infrastructure.entity.PaymentEntity entity);
    ...
    @Mapping(target = "delFlag", constant = "0")
    com.bytz.cms.payment.infrastructure.entity.PaymentTransactionEntity toTransactionEntity(PaymentTransactionEntity domainEntity);
    ...
    PaymentTransactionEntity toDomainTransaction(com.bytz.cms.payment.infrastructure.entity.PaymentTransactionEntity entity);
     ...
     * @return 支付流水领域实体列表
     */
    List<PaymentTransactionEntity> toDomainTransactions(List<com.bytz.cms.payment.infrastructure.entity.PaymentTransactionEntity> entities);
